select * from actor_films where actor='Brigitte Bardot';
...
select 
    ...
    case when y.actorid is null then ARRAY[ROW(t.film, t.votes, t.rating,  t.filmid)::films]
        when t.actorid is not null then y.films || ARRAY[ROW(t.film, t.votes, t.rating,  t.filmid)::films]
        else y.films
    end as films,
...
select * from actor where actor='Brigitte Bardot';